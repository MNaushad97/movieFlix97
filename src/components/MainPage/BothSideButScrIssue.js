...
const MainPageMovies = () => {
  ...
  const INITIAL_ITEM_COUNT = 3; //size of array --->total 10 users 0-9 only | 10009 will be "last user"
  const generated = [];
  ...
  const fetchMovies = async (movieYear, type, index) => {
    ...
    try {
      ...
      if (type === "prevYear") {
        ...
        setNextMovieList([a, ...nextMovieList]);
  ...
  return (
    <div className="mainPage">
      <Virtuoso
        ...
        initialTopMostItemIndex={nextMovieList.length - 1}
