...
A responsive web application that displays a [`virtualized`]([https://betterprogramming.pub/virtualized-rendering-from-scratch-in-react-34c2ad482b16](https://www.patterns.dev/vanilla/virtual-lists)) list of movies from The Movie Database (TMDb) API. The app shows top movies for each year and users can filter by genre.
